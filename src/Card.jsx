...
<div className="card-wrapper">
    ...
    <div className="card flex justify-between items-center flex-col shadow-xl  shadow-blue-500/30 rounded-2xl">
    <div className="platform flex flex-col justify-center items-center mt-20">

         <div className="contest-difficulty text-3xl p-2">
            <h1>{contest.name}</h1>
         </div>
    </div>
    ...
    <div className="happening-date bg-green-300 text-center w-full h-12 flex items-center justify-center">
        <h1 className="text-3xl">{ getDate() }</h1>
    </div>
